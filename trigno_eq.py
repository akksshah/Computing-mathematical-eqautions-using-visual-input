...
def trigno():
    ...
    while cap.isOpened():
        ...
        # rectangle frame for cosec operator
        cv2.rectangle(frame, (1050, 50), (1175, 175), (100, 100, 255), 2)
        roi5 = frame[50:175, 1050:1175, :]
        cv2.putText(frame, "cosec", (1050, 112), cv2.FONT_HERSHEY_DUPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)

        # rectangle frame for sec operator
        cv2.rectangle(frame, (1050, 205), (1175, 330), (100, 100, 255), 2)
        roi6 = frame[205:330, 1050:1175, :]
        cv2.putText(frame, "sin", (1090, 267), cv2.FONT_HERSHEY_DUPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)

        # rectangle frame for cot operator
        cv2.rectangle(frame, (1050, 360), (1175, 485), (100, 100, 255), 2)
        roi7 = frame[360:485, 1050:1175, :]
        cv2.putText(frame, "cot", (1090, 422), cv2.FONT_HERSHEY_DUPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
        ...
        # detecting dot in sec rectangle
        ...
        # detecting dot in cot rectangle
        if len(contours7) > 0:
            drawing_started = True
            # print("root")
